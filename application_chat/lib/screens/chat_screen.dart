...
//     try {
//       final message = await _apiService.sendMessage(widget.chatId, _controller.text.trim());
...
//                               final isMe = message.sender.uid == _authService.currentUser!.uid;
...
//         ? DateFormat('MMM dd, HH:mm').format(tz.TZDateTime.from(_recipientLastSeen!, istLocation))
//         : null;
...
//                 if (formattedLastSeen != null && !_isRecipientOnline)
//                   Text(
